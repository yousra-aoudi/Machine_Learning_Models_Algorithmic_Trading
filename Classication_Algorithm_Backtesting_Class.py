# Python Module with Class for Vectorized Backtesting of Machine Learning-Based Strategies
...
if __name__ == '__main__':
    scibt = ScikitVectorBacktester('AMZN', '2015-1-2', '2022-05-31', 10000, 0.0, 'regression')
    print(scibt.run_strategy('2015-1-2', '2022-05-31', '2015-1-2', '2022-05-31'))
    print(scibt.run_strategy('2015-1-2', '2018-12-31', '2019-1-2', '2022-05-31'))
    scibt.plot_results()
    scibt = ScikitVectorBacktester('AMZN', '2015-1-2', '2022-05-31', 10000, 0.0, 'logistic')
    print(scibt.run_strategy('2015-1-2', '2022-05-31', '2015-1-2', '2022-05-31'))
    print(scibt.run_strategy('2015-1-2', '2018-12-31', '2019-1-2', '2022-05-31'))
    scibt.plot_results()
    scibt = ScikitVectorBacktester('AMZN', '2015-1-2', '2022-05-31', 10000, 0.001, 'logistic')
    print(scibt.run_strategy('2015-1-2', '2022-05-31', '2015-1-2', '2022-05-31', lags=15))
    print(scibt.run_strategy('2015-1-2', '2018-12-31', '2019-1-2', '2022-05-31', lags=15))
    scibt.plot_results()