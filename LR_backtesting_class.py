...
if __name__ == '__main__':
    lrbt = LRVectorBacktester('SPY', '2015-1-31', '2020-12-31', 10000, 0.0)
    print(lrbt.run_strategy('2015-1-2', '2022-05-31', '2015-1-2', '2022-05-31'))
    print(lrbt.run_strategy('2015-1-2', '2019-12-31', '2020-1-2', '2022-05-31'))
    lrbt.plot_results()
    lrbt = LRVectorBacktester('GLD', '2015-1-2', '2022-05-31', 10000, 0.001)
    print(lrbt.run_strategy('2015-1-2', '2022-05-31', '2015-1-2', '2022-05-31', lags=5))
    print(lrbt.run_strategy('2015-1-2', '2019-12-31', '2020-1-2', '2022-05-31', lags=5))
    lrbt.plot_results()
